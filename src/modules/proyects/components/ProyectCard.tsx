...
import type { ProyectCardProps } from "../type/type";

export const ProyectCard = ({ project, addToProjectsRef }: ProyectCardProps) => {
              ...
              <div className="p-8">
                ...
                <div className="lg:hidden flex flex-wrap gap-2 mb-6">
                  {project.technologies.slice(0, 3).map(tech => (
                    <span
                      key={tech}
                      className="px-2 py-1 bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-200 rounded text-sm border border-blue-200 dark:border-blue-800"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="flex gap-3">
                  {project.githubUrl && (
                    ...
                    >
                      <Github size={18} />
                      <span>Code</span>
                      <div className="w-0 group-hover/github:w-4 h-0.5 bg-current transition-all duration-300"></div>
                    </a>
                  )}
                  ...
                  {project.liveUrl && (
                    ...
                    >
                      ...
                      <span>Live Demo</span>
                      <div className="w-0 group-hover/live:w-4 h-0.5 bg-white transition-all duration-300"></div>
                    </a>
                  )}
                </div>
              </div>
