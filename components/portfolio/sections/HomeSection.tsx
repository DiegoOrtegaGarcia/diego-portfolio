...
export function HomeSection() {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center py-16 px-4 relative overflow-hidden pt-28 md:pt-0 scroll-mt-24"
    >
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16">
          <div className="w-full lg:w-2/5 flex justify-center lg:justify-start order-2 lg:order-1">
            <div className="relative group">
              <div
                ref={imageRef}
                className="relative z-10 w-72 h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-3xl overflow-hidden  shadow-2xl"
              >
                <Image
                  src="/images/Copia.png"
              ...
              <div
                className={`absolute -inset-6 rounded-3xl border-4 ${
                  darkMode ? 'border-red-500/30' : 'border-red-700/30'
                } opacity-60 group-hover:opacity-100 transition-all duration-500 group-hover:scale-105`}
              />
            </div>
          </div>
          ...
          <div className="w-full lg:w-3/5 text-center lg:text-left order-1 lg:order-2">
            <div className="space-y-6 lg:space-y-8">
              <div ref={titleRef}>
                ...
                >
                  ...
                  >
                    Diego
                    <Sparkles
                      className="absolute -top-4 -right-6 w-6 h-6 animate-pulse"
              ...
              <div ref={descriptionRef}>
                <p
                  className={`text-xl md:text-2xl max-w-3xl mx-auto lg:mx-0 leading-relaxed ${
                    darkMode ? 'text-gray-300' : 'text-gray-600'
                  }`}
                >
                  Apasionado por el desarrollo web y la experiencia de usuario. Especializado en crear{' '}
                ...
                >
                  ...
                  <div
                    className={`absolute inset-0 bg-gradient-to-r ${
                      darkMode ? 'from-red-500 to-red-600' : 'from-red-600 to-red-700'
